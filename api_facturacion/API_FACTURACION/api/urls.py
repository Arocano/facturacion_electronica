...
urlpatterns = [
    ...
    path('logoempresa/<str:id_empresa>/', LogoVista.as_view(), name='logoempresa_proceso'),
    path('firmaempresa/<str:id_empresa>/', FirmaVista.as_view(),name='firmaempresa_proceso'),
    path('iva/<str:id_empresa>/', IvaVista.as_view(), name='iva_lista'),
    path('iva/<str:id_empresa>/<str:id_iva>/',IvaVista.as_view(), name='iva_proceso'),
